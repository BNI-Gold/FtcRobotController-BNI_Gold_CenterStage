package org.firstinspires.ftc.teamcode.Personal_Spaces.MatthewT.Camden.CustomPID;

public class CrazyPIDThing {
    ...
    public CrazyPIDThing(double Kp, double Ki, double Kd)
    {
        m_P = Kp;
        m_I = Ki;
        m_D = Kd;
